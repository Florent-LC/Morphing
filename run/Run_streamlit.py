...
def main():
    ...
    image1 = col1.image(
        np.zeros_like(img_model_image),
        use_column_width=True,
        caption="Transformed input",
    )
    image2 = col2.image(
        img_model_image, use_column_width=True, caption="Generated Image"
    )
    ...
    action_selection = st.sidebar.selectbox(
        "What do you want to do?", options=["Nothing", "Detection", "Morphing"]
    )
